...
class CreateContents(unittest.TestCase):
    ...
    def verify_login_page(self):
        self.assertTrue(self.is_element_present(By.XPATH, self.user_field_xpath))
        self.assertTrue(self.is_element_present(By.XPATH, self.pass_field_xpath))
        self.assertTrue(self.is_element_present(By.XPATH, self.login_button_xpath))
    ...
    def admin_hover_menu(self):
        ...
        site_type_xpath = "//div[contains(@id, 'edit-field-basic-page-site-type')]//input[contains(@id, 'edit-field-basic-page-site-type-und-2')]"
        self.assertTrue(self.is_element_present(By.XPATH, site_type_xpath))
        self.driver.find_element_by_xpath(site_type_xpath).click()
